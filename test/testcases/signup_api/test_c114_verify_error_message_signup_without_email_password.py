import allure
from testdata.signup_api.data_signup_without_email_password import response, response_body
...
def test_c114_05_error_message():
    assert response_body['errors'][1]["message"] == "Password must be 8 character long"
