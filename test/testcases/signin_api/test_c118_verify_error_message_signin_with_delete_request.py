import allure
from testdata.signin_api.data_signin_with_delete_request import response, response_body


@allure.step('Signin api, status code validation')
def test_c118_01_status_code_is_404():
    assert response.status_code == 404


@allure.step("Signin api, body not none validation")
def test_c118_02_response_body_not_none():
